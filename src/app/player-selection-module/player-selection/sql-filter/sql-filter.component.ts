...
@Component({
  ...
  styleUrls: ['./sql-filter.component.scss']
})
export class SqlFilterComponent implements OnInit {
  ...
  constructor(public datepipe: DatePipe,public playerSelectionService:PlayerSelectionService) {
...
//    debugger;
    ...
    if(!this.viewdata.value2){
     ...
     // return;
     //this.playerSelectionServicetrue;
    }
